    ...
    <main class="contenedor">
        <section class="contenido">
            ...
            <article class="descripcion">
                <div>
                    <a class="flecha" href="../detalle/detalle_vip.php"><img src="/build/img/arrow_left.png" alt="Flecha retroceder"></a>
                </div>
                <div class="descripcion-contenido">
                    <div>
                        <img src="/build/img/lavado_asientos.webp" alt="Imagen Lavado Basico">
                        <a class="volver" href="/servicios.php">↪ Volver a servicios</a>
                    </div>

                    <div class="descripcion-servicio">
                        <H2>Lavado de tapicería</H2>
                        <hr>
                        <p>Este servicio ofrece un lavado interior, donde <span class="negrita">hace falta pedir cita previa.</span>  
                        ...
                        <p>Nuestro lavado de tapisería incluye los siguientes productos y servicios:</p>
                        <ul>
                        ...
                        <div>
                            <p class="precio">59.99€ <span>(Coche normal)</span></p>
                        </div>
                    </div>
                </div>
                <div>
                    <a class="flecha" href="../detalle/detalle_asientosCompl.php"><img src="/build/img/arrow_right.png" alt="Flecha avansar"></a>
                </div>
